  ...
  return (
     <View style={styles.container}>
      ...
      <View style={styles.infoCard}>
        ...
        <Text style={styles.infoText} onPress={handleEmail}>support@superxpense.com</Text>
      </View>

      <View style={styles.infoCard}>
        <Icon name="phone" size={24} color="#34c759" style={styles.icon} />
        <Text style={styles.infoText} onPress={handlePhone}>+971 5507895</Text>
      </View>

      <View style={styles.infoCard}>
        <Icon name="location-on" size={24} color="#ff3b30" style={styles.icon} />
